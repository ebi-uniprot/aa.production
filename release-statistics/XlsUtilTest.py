...
class TestXlsUtilMethods(unittest.TestCase):
    ...
    def test_happy_path(self):
        xls_util = XlsUtil()
        self.assertEqual(xls_util.generate_deviations_sheet_name('report-2018_01.txt', 'report-2018_02.txt'), '2018_01-vs-2018_02')
        print(xls_util.generate_deviations_sheet_name('report-2018_01.txt', 'report-2018_02.txt'))
